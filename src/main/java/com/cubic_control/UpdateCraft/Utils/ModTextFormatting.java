...
public enum ModTextFormatting
{
    ...
    private static final Map<String, ModTextFormatting> nameMapping = Maps.<String, ModTextFormatting>newHashMap();
    /**
    ...
    private ModTextFormatting(String formattingName, char formattingCodeIn, int colorIndex)
    {
    ...
    private ModTextFormatting(String formattingName, char formattingCodeIn, boolean fancyStylingIn, int colorIndex)
    {
     ...
     */
    public static ModTextFormatting getValueByName(String friendlyName)
    {
        return friendlyName == null ? null : (ModTextFormatting)nameMapping.get(lowercaseAlpha(friendlyName));
    }
     ...
     */
    public static ModTextFormatting fromColorIndex(int index)
    {
        if (index < 0)
        {
            return RESET;

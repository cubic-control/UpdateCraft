...
public class GuiAdvancementTab extends Gui{
    ...
    public GuiAdvancementTab(Minecraft mc, GuiScreenAdvancements gsa, AdvancementTabType att, int p_i47589_4_, Advancement advancement, DisplayInfo displayInfo){
        this.field_191802_a = mc;
        this.field_193938_f = gsa;
        this.field_191803_f = att;
        this.field_191804_g = p_i47589_4_;
        this.field_191805_h = advancement;
        this.field_191806_i = displayInfo;
        this.field_191807_j = displayInfo.getIcon();
        this.field_191808_k = displayInfo.getTitle().getFormattedText();
        this.field_191809_l = new GuiAdvancement(this, mc, advancement, displayInfo);
        this.func_193937_a(this.field_191809_l, advancement);
    }
    ...
    public void func_191799_a(){
        ...
        ResourceLocation resourcelocation = this.field_191806_i.getBackground();

        if(resourcelocation != null){
            this.field_191802_a.getTextureManager().bindTexture(resourcelocation);
        }else{
            this.field_191802_a.getTextureManager().bindTexture(null);
        }
    ...
    public void func_191800_a(Advancement p_191800_1_)
    {
        ...
        {
            GuiAdvancement guiadvancement = new GuiAdvancement(this, this.field_191802_a, p_191800_1_, p_191800_1_.getDisplay());

...
public class ModItemSpawnEgg extends ItemMonsterPlacer
{
    ...
    public ModItemSpawnEgg(String parEntityToSpawnName, int parPrimaryColor, int parSecondaryColor, String parSpawnName){

...
enum AdvancementTabType{
    ...
    public void func_192651_a(Gui guiIn, int x, int y, boolean p_192651_4_, int p_192651_5_){
        ...
        int j = p_192651_4_ ? this.field_192661_g + this.height : this.field_192661_g;
        guiIn.drawTexturedModalRect(x + this.func_192648_a(p_192651_5_), y + this.func_192653_b(p_192651_5_), i, j, this.width, this.height);
    }

    public void func_192652_a(int p_192652_1_, int p_192652_2_, int p_192652_3_, RenderItem renderItemIn, ItemStack stack){
        ...
        renderItemIn.renderItemAndEffectIntoGUI(mc.fontRenderer, mc.getTextureManager(), stack, i, j);
        //renderItemIn.renderItemAndEffectIntoGUI((EntityLivingBase)null, (EntityLivingBase)null, stack, i, j);
    }

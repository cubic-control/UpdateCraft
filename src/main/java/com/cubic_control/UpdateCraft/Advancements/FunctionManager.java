...
public class FunctionManager implements ITickable{
    ...
    private final ICommandSender gameLoopFunctionSender = new ICommandSender()
    {
        ...
        {
            return FunctionManager.this.server.worldServers[0];
        }
    ...
    {
        return this.server.worldServers[0].getGameRules().getInt("maxCommandChainLength");
    }
    ...
    public void update()
    {
        String s = this.server.worldServers[0].getGameRules().getGameRuleStringValue("gameLoopFunction");

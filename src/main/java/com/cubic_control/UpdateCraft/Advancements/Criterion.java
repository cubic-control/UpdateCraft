...
public class Criterion
{
    ...
    {
        ResourceLocation resourcelocation = new ResourceLocation(JsonUtils.getJsonElementStringValue(p_192145_0_, "trigger"));
        ...
        {
            ICriterionInstance icriterioninstance = icriteriontrigger.deserializeInstance(JsonUtils.getJsonObjectFieldOrDefault(p_192145_0_, "conditions", new JsonObject()), p_192145_1_);
    ...
    public static Map<String, Criterion> func_192144_b(JsonObject p_192144_0_, JsonDeserializationContext p_192144_1_)
    {
        ...
        {
            map.put(entry.getKey(), func_192145_a(JsonUtils.getJsonElementAsJsonObject(entry.getValue(), "criterion"), p_192144_1_));
        }

        return map;
    }

    public static Map<String, Criterion> func_192142_c(PacketBuffer p_192142_0_) throws IOException
    {
        Map<String, Criterion> map = Maps.<String, Criterion>newHashMap();
    ...
    public static void func_192141_a(Map<String, Criterion> p_192141_0_, PacketBuffer p_192141_1_) throws IOException
    {
        p_192141_1_.writeVarIntToBuffer(p_192141_0_.size());

        for (Entry<String, Criterion> entry : p_192141_0_.entrySet())
        {
            p_192141_1_.writeStringToBuffer(entry.getKey());

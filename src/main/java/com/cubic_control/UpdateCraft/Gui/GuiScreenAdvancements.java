...
import com.cubic_control.UpdateCraft.Main.MKeys;
...
{
    private static final ResourceLocation WINDOW = new ResourceLocation(RefStrings.MODID+":textures/gui/advancements/window.png");
    private static final ResourceLocation TABS = new ResourceLocation(RefStrings.MODID+":textures/gui/advancements/tabs.png");
    //TODO:
    ...
    public void initGui(){
        ...
        //TODO:
        //this.field_191946_h.setListener(this);

        if(this.field_191940_s == null && !this.field_191947_i.isEmpty()){
        	//TODO:
            //this.field_191946_h.setSelectedTab(((GuiAdvancementTab)this.field_191947_i.values().iterator().next()).func_193935_c(), true);
        }else{
        	//TODO:
            //this.field_191946_h.setSelectedTab(this.field_191940_s == null ? null : this.field_191940_s.func_193935_c(), true);
        }
    }
    ...
    public void onGuiClosed(){
    	//TODO:
        //this.field_191946_h.setListener((ClientAdvancementManager.IListener)null);
        ...
        if(mouseButton == 0){
            ...
            for(GuiAdvancementTab guiadvancementtab : this.field_191947_i.values()){
                if(guiadvancementtab.func_191793_c(i, j, mouseX, mouseY)){
                	//TODO:
                    //this.field_191946_h.setSelectedTab(guiadvancementtab.func_193935_c(), true);
                    break;
                }
            }
        }
    ...
    {
        if(keyCode == MKeys.advancements.getKeyCode())
        {
    ...
    {
        GuiAdvancementTab guiadvancementtab = GuiAdvancementTab.func_193936_a(this.mc, this, this.field_191947_i.size(), advancementIn);

...
public class AdvancementTreeNode
{
    ...
    private AdvancementTreeNode func_192322_a(Advancement p_192322_1_, @Nullable AdvancementTreeNode p_192322_2_)
    {
        ...
        {
            p_192322_2_ = new AdvancementTreeNode(p_192322_1_, this, p_192322_2_, this.field_192332_e.size() + 1, this.x + 1);
    ...
    private void func_192320_a()
    {
        if (this.field_192332_e.isEmpty())
        {
            ...
            {
                this.y = this.field_192330_c.y + 1.0F;
            }
            else
            {
                this.y = 0.0F;
        ...
        else
        {
            ...
            this.func_192325_b();
            float f = ((this.field_192332_e.get(0)).y + (this.field_192332_e.get(this.field_192332_e.size() - 1)).y) / 2.0F;

            if (this.field_192330_c != null)
            {
                this.y = this.field_192330_c.y + 1.0F;
                this.field_192337_j = this.y - f;
            }
            else
            {
                this.y = f;
    ...
    {
        if (this.field_192328_a.getDisplay() != null)
        {
            this.field_192328_a.getDisplay().setPosition((float)this.x, this.y);
        }
    ...
    public static void func_192323_a(Advancement root)
    {
        ...
        else
        {
            ...
            float f = advancementtreenode.func_192319_a(0.0F, 0, advancementtreenode.y);

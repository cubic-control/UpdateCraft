...
public class RenderModBlockChorusPlant extends RenderModBlockChorusFlower {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		...
		if(neighbourUp == MBlocks.chorus_flower || neighbourUp == Blocks.end_stone || neighbourUp == block){
		...
		if(neighbourDown == MBlocks.chorus_flower || neighbourDown == Blocks.end_stone || neighbourDown == block){
		...
		if(neighbourWest == MBlocks.chorus_flower || neighbourWest == Blocks.end_stone || neighbourWest == block){
		...
		if(neighbourEast == MBlocks.chorus_flower || neighbourEast == Blocks.end_stone || neighbourEast == block){
		...
		if(neighbourNorth == MBlocks.chorus_flower || neighbourNorth == Blocks.end_stone || neighbourNorth == block){
		...
		if(neighbourSouth == MBlocks.chorus_flower || neighbourSouth == Blocks.end_stone || neighbourSouth == block){

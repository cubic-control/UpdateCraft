...
import com.cubic_control.UpdateCraft.Utils.DispenserBehaviourLingeringPotion;
...
public class ModItemLingeringPotion extends ItemPotion{

	@SideOnly(Side.CLIENT)
	private IIcon bottle;

	public ModItemLingeringPotion() {
		...
		GameRegistry.registerItem(this, "lingering_potion");
	}
	@Override
	...
	public void registerIcons(IIconRegister reg) {
		...
		bottle = reg.registerIcon(RefStrings.MODID + ":potion_bottle_lingering");
	}
	@Override
	@SideOnly(Side.CLIENT)

...
/**
 * 
 * Ported from forge 14.21.0.2343
 *
 */
...
public class ModelIllager extends ModelBase{
    ...
    public ModelIllager(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
        ...
        this.field_193775_b = (new ModelRenderer(this, 32, 0)).setTextureSize(textureWidthIn, textureHeightIn);
        this.field_193775_b.addBox(-4.0F, -10.0F, -4.0F, 8, 12, 8, scaleFactor + 0.45F);
        this.head.addChild(this.field_193775_b);
